...
<head>
    ...
    <title>Journal -@yield('title', 'website')</title>
            ...
            <div class="row pb-4 pt-4 px-2 justify-content-between">
                <div class="col-md-6 ">
                    <div class="d-flex flex-row justify-content-around">
                        <img src="{{ asset('img/د مدرسې  لوګو.jpg') }}" alt="logo" class="rounded-circle imge-fluid"
                ...
                <div class="col-md-6">
                    <div class="d-flex flex-row justify-content-around">
                        <h4 class="text-white align-self-center d-none d-sm-block">
                            Kandahar University <br />of Education and Research
                        </h4>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('autherguide') }}" class="nav-link">Author GuideLine</a>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="col-lg-4">
                            <div class="footer-widget">
                                ...
                                <ul>
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ route('editorial') }}">Editorail Board</a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ route('autherguide') }}">AutherGuideLine</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
